...
# -----------------------
for key in ["child_name", "location", "registered_face", "logged_in"]:
    if key not in st.session_state:
        st.session_state[key] = "" if key != "registered_face" else None
...
def login_ui():
    ...
    # Child Name & Location input
    st.session_state.child_name = st.sidebar.text_input(
        "Child Name", value=st.session_state.child_name
    )
