...
def login_ui():
    ...
    if st.sidebar.button("Login"):
        ...
        st.sidebar.info("📸 Please look at the camera for face verification...")
        ...
        if ctx.video_processor:
            if ctx.video_processor.verified is True:
                ...
                st.sidebar.warning("⌛ Verifying... Please wait and look at the camera")
