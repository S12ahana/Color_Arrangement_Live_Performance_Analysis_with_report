...
# LOGIN FACE CAPTURE
# ==============================
st.subheader("📸 Login Face Capture")

if st.button("📷 Capture Login Face"):
...
if st.button("⚡ Analyze Snapshot"):
    if not ctx.video_processor.identity_matched:
        st.error("🚫 FACE MISMATCH – Access Blocked")
        st.stop()

    st.success("✅ Face Matched – Analysis Allowed")