...
# ==============================
# LOGIN FACE CAPTURE (MAIN AREA)
# ==============================
st.subheader("📸 Capture Face for Login")

if st.button("📷 Capture Login Face", key="capture_login_main"):
    if ctx.video_processor and ctx.video_processor.frame is not None:
        ...
        if len(faces) == 0:
            ...
            st.session_state.login_face = face
            ctx.video_processor.reference_face = face

            st.success("✅ Login face captured")
    else:
...
# ANALYZE SNAPSHOT
# ==============================
if st.button("⚡ Analyze Snapshot", key="analyze_snapshot"):
