...
def generate_pdf(data, feedback, photo=None, pie_values=None, pie_labels=None):
    ...
    # =================================================
    # PIE CHART  (Clean + compact so feedback stays same page)
    # =================================================
    if pie_values and pie_labels and sum(pie_values) > 0:

        pie_path = "output/temp_pie.png"

        fig, ax = plt.subplots(figsize=(4.5, 3.5))

        # IMPORTANT: 3 outputs when autopct used
        ...
        pie_img = Image(pie_path, width=3.8 * inch, height=3 * inch)
